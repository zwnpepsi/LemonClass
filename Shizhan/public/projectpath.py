...
cf.read(os.path.join(os.path.join(config_file_path,"conf"),"project.conf"))
...
#测试结果所在路径
testresult_path=os.path.join(os.path.join(project_path,"Results"),"test_result")

#测试结果集所在路径
Results_path=os.path.join(project_path,"Results")

#http.conf所在路径
httpconf_path=os.path.join(os.path.join(project_path,"conf"),"http.conf")

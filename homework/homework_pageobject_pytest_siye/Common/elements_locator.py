...
#-----------------------------首页元素-----------------------------
    #首页-投标名称
home_bid_name_locator = "//span[contains(text(),'%s')]"
    #首页-抢投标按钮
home_bid_grad_locator = "//span[contains(text(),'%s')]/ancestor::a/following-sibling::div//a[text()='抢投标']"
    #首页-我的账户按钮
home_myAccount_locator = "//a[@href='/Member/index.html']"
    #首页-投标按钮
home_bid_button_locator = "//a[text()='投标']"
    #首页-明星蜂群按钮
home_starHive_button_locator = "//a[text()='明星蜂群']"
    #首页-推荐的明星蜂群按钮
home_starHive_locator = "//div[contains(text(),%s)]/ancestor::li"
